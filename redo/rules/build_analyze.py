...
def _analyze_ada_sources(source_files, base_dir, build_target, binary_mode=False):
    ...
    try:
        ...
        print(f"The file '{gpr_project_file}' does not exist.")
    ...
    analyze_cmd = "gnatsas analyze -P" + gnatsas_gpr_file + suffix
    ret = shell.try_run_command(analyze_cmd)

    # Make CSV report
    csv_out_file = os.path.join(output_dir, "report.csv")
    csv_cmd = "gnatsas report csv -P" + gnatsas_gpr_file + " --out " + csv_out_file
