...
class build_coverage_all(build_rule_base):
    ...
    def _generate_index_html(self, index_path, flight_html, flight_txt, test_html, generated_html, complete_html, coverage_txt):
        ...
        flight_txt_name = os.path.basename(flight_txt)
...
<body>
    <div class="container">
        ...
        <div class="report-section">
            ...
            <div class="report-description">
                Coverage analysis of auto-generated code. This report is useful for verifying that generated code paths are properly exercised by tests.
            </div>
            <div class="report-links">
        ...
        <div class="footer">
            Generated by <a href="https://github.com/lasp/adamant" target="_blank" style="color: #3498db; text-decoration: none;">Adamant</a> on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
        </div>
    </div>
</body>
</html>"""
