...
def _build_pydeps(source_file, path=[]):
    ...
    def _inner_build_pydeps(source_file):
        ...
        # For the nonexistant dependencies, see if we have a rule
        # to build those:
        if nonexistant_deps:
            deps_to_build = []
...
if __name__ == "__main__":
    ...
    print("")
    print("Existing depdendencies: ")
    for dep in existing_deps:
        print(dep)
    print("")
    print("Nonexistant dependencies: ")
    for dep in nonexistant_deps:
        print(dep)
    print("")
    print("Building nonexistant dependencies: ")
