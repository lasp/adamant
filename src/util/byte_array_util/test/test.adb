--------------------------------------------------------------------------------
-- Byte_Array_Util Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Byte_Array_Util_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Byte_Array_Util_Tests.Implementation.Suite.Get);
