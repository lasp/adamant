package body In_Return_Connector is
   ...
   function Call (Self : in Instance; Input : in T) return R is
   begin
      pragma Assert (Self.Connected);
      return Self.Hook.all (Self.Component_Access.all, Input, Self.Index);
   end Call;
