...
package body Ccsds_Downsampler_Tests.Implementation is
   ...
   begin
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (1), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 0));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (2), Test_Dp_Recieved (Packed_Passed_Dp_Id, 0));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (3), Test_Dp_Recieved (2, 0));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (4), Test_Dp_Recieved (3, 3));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (5), Test_Dp_Recieved (4, 1));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (6), Test_Dp_Recieved (5, 4));
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (7), Test_Dp_Recieved (6, 2));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (8), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 1));

      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 0);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 9);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (9), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 2));

      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 0);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 10);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (10), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 3));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (11), Test_Dp_Recieved (Packed_Passed_Dp_Id, 1));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (12), Test_Dp_Recieved (Packed_Passed_Dp_Id, 2));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (13), Test_Dp_Recieved (Packed_Passed_Dp_Id, 3));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (14), Test_Dp_Recieved (Packed_Passed_Dp_Id, 4));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (15), Test_Dp_Recieved (Packed_Passed_Dp_Id, 5));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 16);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (16), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 4));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 17);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (17), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 5));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (18), Test_Dp_Recieved (Packed_Passed_Dp_Id, 6));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 19);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (19), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 6));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 20);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (20), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 7));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (21), Test_Dp_Recieved (Packed_Passed_Dp_Id, 7));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (22), Test_Dp_Recieved (Packed_Passed_Dp_Id, 8));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (23), Test_Dp_Recieved (Packed_Passed_Dp_Id, 9));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (24), Test_Dp_Recieved (Packed_Passed_Dp_Id, 10));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (25), Test_Dp_Recieved (Packed_Passed_Dp_Id, 11));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (26), Test_Dp_Recieved (Packed_Passed_Dp_Id, 12));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (27), Test_Dp_Recieved (Packed_Passed_Dp_Id, 13));
   ...
   begin
      ...
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 11);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (11), Test_Dp_Recieved (2, 1));

      -- Now check that we get messages forwarded
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 1);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 12);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (12), Test_Dp_Recieved (Packed_Passed_Dp_Id, 1));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 2);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 13);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (13), Test_Dp_Recieved (Packed_Passed_Dp_Id, 2));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 3);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 14);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (14), Test_Dp_Recieved (Packed_Passed_Dp_Id, 3));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 4);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 15);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (15), Test_Dp_Recieved (Packed_Passed_Dp_Id, 4));
      ...
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 16);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (16), Test_Dp_Recieved (2, 5));

      -- Check that the appropriate number come out
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 17);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (17), Test_Dp_Recieved (Packed_Passed_Dp_Id, 5));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 18);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (18), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 4));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 19);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (19), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 5));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 20);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (20), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 6));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 5);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 21);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (21), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 7));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 22);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (22), Test_Dp_Recieved (Packed_Passed_Dp_Id, 6));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 23);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (23), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 8));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 24);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (24), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 9));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 25);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (25), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 10));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 6);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 26);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (26), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 11));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 27);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (27), Test_Dp_Recieved (Packed_Passed_Dp_Id, 7));
      ...
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (29), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 12));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 30);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (30), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 13));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 31);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (31), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 14));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 32);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (32), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 15));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 33);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (33), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 16));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 34);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (34), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 17));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 35);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (35), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 18));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 36);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (36), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 19));
      T.Ccsds_Space_Packet_T_Send (Incoming_Packet);
      Natural_Assert.Eq (T.Ccsds_Space_Packet_T_Recv_Sync_History.Get_Count, 7);
      Natural_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get_Count, 37);
      Data_Product_Assert.Eq (T.Data_Product_T_Recv_Sync_History.Get (37), Test_Dp_Recieved (Packed_Filtered_Dp_Id, 20));
