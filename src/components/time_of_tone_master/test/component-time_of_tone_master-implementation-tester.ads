--------------------------------------------------------------------------------
-- Time_Of_Tone_Master Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Time_Of_Tone_Master_Reciprocal;
with Sys_Time;
...
package Component.Time_Of_Tone_Master.Implementation.Tester is
   ...
   use Component.Time_Of_Tone_Master_Reciprocal;
   ...
   package Time_Messages_Sent_History_Package is new Printable_History (Packed_U32.T, Packed_U32.Representation.Image);
   package Time_At_Tone_State_History_Package is new Printable_History (Tat_State.T, Tat_State.Representation.Image);

   -- Component class instance:
   type Instance is new Component.Time_Of_Tone_Master_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Time_Of_Tone_Master.Implementation.Instance;
      -- Connector histories:
      ...
      Time_Messages_Sent_History : Time_Messages_Sent_History_Package.Instance;
   ...
   -----------------------------------------------
   -- Description:
   --    Events for the Time of Tone Master component.
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Time of Tone Master component.
   -- The number of tone messages sent.
   overriding procedure Tone_Messages_Sent (Self : in out Instance; Arg : in Packed_U32.T);
   -- The number of time messages sent.
   overriding procedure Time_Messages_Sent (Self : in out Instance; Arg : in Packed_U32.T);
...
end Component.Time_Of_Tone_Master.Implementation.Tester;
