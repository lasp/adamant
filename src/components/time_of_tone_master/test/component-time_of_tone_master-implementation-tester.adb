--------------------------------------------------------------------------------
-- Time_Of_Tone_Master Component Tester Body
--------------------------------------------------------------------------------

package body Component.Time_Of_Tone_Master.Implementation.Tester is
   ...
   begin
      ...
      Self.Time_Messages_Sent_History.Init (Depth => 100);
   ...
   begin
      ...
      Self.Time_Messages_Sent_History.Destroy;
   ...
   begin
      ...
      Self.Attach_Tone_Message_Sys_Time_T_Send (To_Component => Self.Component_Instance'Unchecked_Access, Hook => Self.Component_Instance.Tone_Message_Sys_Time_T_Recv_Sync_Access);
   ...
   overriding procedure Time_Messages_Sent (Self : in out Instance; Arg : in Packed_U32.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Time_Messages_Sent_History.Push (Arg);
   end Time_Messages_Sent;
