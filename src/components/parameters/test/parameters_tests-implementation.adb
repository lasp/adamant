...
package body Parameters_Tests.Implementation is
   ...
   overriding procedure Test_Validate_Parameter_Defaults (Self : in out Instance) is
      T : Component.Parameters.Implementation.Tester.Instance_Access renames Self.Tester;
   ...
   begin
      ...
      T.Component_A.Validate_Parameter_Defaults;
      T.Component_B.Validate_Parameter_Defaults;
      T.Component_C.Validate_Parameter_Defaults;

      -- A component whose validation rejects its defaults fails an assertion:
      begin
         Bad_Component.Validate_Parameter_Defaults;
      exception
         when Ada.Assertions.Assertion_Error =>
            Assertion_Raised := True;
      end;
      Boolean_Assert.Eq (Assertion_Raised, True);
   end Test_Validate_Parameter_Defaults;
