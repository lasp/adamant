...
package Component.Ccsds_Socket_Interface.Implementation.Tester is
   ...
   package Socket_Connected_History_Package is new Printable_History (Socket_Address.T, Socket_Address.Representation.Image);
   package Socket_Not_Connected_History_Package is new Printable_History (Socket_Address.T, Socket_Address.Representation.Image);
   package Packet_Send_Failed_History_Package is new Printable_History (Ccsds_Primary_Header.T, Ccsds_Primary_Header.Representation.Image);
   package Packet_Recv_Failed_History_Package is new Printable_History (Ccsds_Primary_Header.T, Ccsds_Primary_Header.Representation.Image);
   ...
   overriding procedure Socket_Connected (Self : in out Instance; Arg : in Socket_Address.T);
   -- The socket connection failed on the host and port provided
   overriding procedure Socket_Not_Connected (Self : in out Instance; Arg : in Socket_Address.T);
   -- Failed to send a packet over the socket because it has an invalid CCSDS header.
   overriding procedure Packet_Send_Failed (Self : in out Instance; Arg : in Ccsds_Primary_Header.T);
   -- Failed to receive a packet over the socket because it has an invalid CCSDS header.
   overriding procedure Packet_Recv_Failed (Self : in out Instance; Arg : in Ccsds_Primary_Header.T);
