...
package body Component.Ccsds_Socket_Interface.Implementation.Tester is
   ...
   begin
      ...
      -- Event histories:
      Self.Socket_Connected_History.Init (Depth => 100);
      Self.Socket_Not_Connected_History.Init (Depth => 100);
      Self.Packet_Send_Failed_History.Init (Depth => 100);
      Self.Packet_Recv_Failed_History.Init (Depth => 100);
   end Init_Base;
   ...
   overriding procedure Socket_Connected (Self : in out Instance; Arg : in Socket_Address.T) is
   begin
      -- Push the argument onto the test history for looking at later:
   ...
   overriding procedure Socket_Not_Connected (Self : in out Instance; Arg : in Socket_Address.T) is
   begin
      -- Push the argument onto the test history for looking at later:
   ...
   overriding procedure Packet_Send_Failed (Self : in out Instance; Arg : in Ccsds_Primary_Header.T) is
   begin
      -- Push the argument onto the test history for looking at later:
   ...
   overriding procedure Packet_Recv_Failed (Self : in out Instance; Arg : in Ccsds_Primary_Header.T) is
   begin
      -- Push the argument onto the test history for looking at later:
