...
private
   ...
   -- This unit test makes sure that packets received through the socket are forwarded through the send connector. This test exercises the additional internal task of the Socket Interface Component.
