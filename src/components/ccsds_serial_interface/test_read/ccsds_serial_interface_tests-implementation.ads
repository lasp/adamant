...
private
   ...
   -- This unit test makes sure that packets received through the serial port are fowarded through the send connector. This test excersizes the additional internal task of the Socket Interface Component.
