...
package Zerodividercpp_C_H is
  ...
  --
   ...
   function Zerodividercpp_Createwithdefaultmagicnumber
      return access Zerodividercpp  -- /home/user/adamant/src/components/zero_divider_cpp/zeroDividerCpp/zeroDividerCpp_c.h:25
   with
  ...
  --
   ...
   function Zerodividercpp_Createwithmagicnumber
     (Magicnumber : Unsigned_32)
      return access Zerodividercpp  -- /home/user/adamant/src/components/zero_divider_cpp/zeroDividerCpp/zeroDividerCpp_c.h:32
   with
  ...
  --
   ...
   procedure Zerodividercpp_Destroy
     (Self : access Zerodividercpp)  -- /home/user/adamant/src/components/zero_divider_cpp/zeroDividerCpp/zeroDividerCpp_c.h:38
   with
