...
package body Zero_Divider_Cpp_Tests.Implementation is
   ...
   -- This unit test makes sure the Divide_By_Zero_In_Cpp command does not execute if
   -- the correct magic number is not provided.
   ...
   -- This unit test makes sure a divide by zero exception is thrown when the
   -- Divide_By_Zero_In_Cpp command executes.
   ...
   begin
      ...
      exception
         ...
         when E : others =>
            pragma Assert (False, "Unexpected exception " & Exception_Information (E));
