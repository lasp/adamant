...
package body Time_At_Tone_Master_Tests.Implementation is
   ...
   begin
      ...
      Tick_Assert.Eq (T.Time_Message_Recv_Sync_History.Get (1), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 0));
      Tick_Assert.Eq (T.Tone_Message_Recv_Sync_History.Get (1), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 0));
      ...
      Tick_Assert.Eq (T.Time_Message_Recv_Sync_History.Get (2), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 1));
      Tick_Assert.Eq (T.Tone_Message_Recv_Sync_History.Get (2), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 1));
      ...
      Tick_Assert.Eq (T.Time_Message_Recv_Sync_History.Get (3), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 2));
      Tick_Assert.Eq (T.Tone_Message_Recv_Sync_History.Get (3), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), 2));
   ...
   begin
      ...
      for Idx in 1 .. 5 loop
         ...
         Tick_Assert.Eq (T.Time_Message_Recv_Sync_History.Get (Idx), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), Unsigned_32 (Idx - 1)));
         Tick_Assert.Eq (T.Tone_Message_Recv_Sync_History.Get (Idx), ((17, 23 + (5 * (Sys_Time.Subseconds_Type'Last / 1_000))), Unsigned_32 (Idx - 1)));
