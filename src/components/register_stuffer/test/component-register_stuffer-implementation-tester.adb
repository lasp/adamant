...
package body Component.Register_Stuffer.Implementation.Tester is
   ...
   begin
      ...
      Self.Last_Dumped_Register_Set_History.Init (Depth => 100);
      -- Packet histories:
   ...
   begin
      ...
      Self.Last_Dumped_Register_Set_History.Destroy;
      -- Packet histories:
   ...
   overriding procedure Registers_Dumped (Self : in out Instance; Arg : in N_Registers.T) is
   begin
      -- Push the argument onto the test history for looking at later:
   ...
   overriding procedure Last_Dumped_Register_Set (Self : in out Instance; Arg : in N_Registers.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Last_Dumped_Register_Set_History.Push (Arg);
   end Last_Dumped_Register_Set;
   ...
   overriding procedure Register_Packet (Self : in out Instance; Arg : in Register_Stuffer_Packet.T) is
   begin
      -- Push the argument onto the test history for looking at later:
