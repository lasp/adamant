--------------------------------------------------------------------------------
-- Cpu_Monitor Component Tester Body
--------------------------------------------------------------------------------

package body Component.Cpu_Monitor.Implementation.Tester is
   ...
   begin
      ...
      -- Packet histories:
      Self.Cpu_Usage_Packet_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      -- Packet histories:
      Self.Cpu_Usage_Packet_History.Destroy;
   end Final_Base;
   ...
   overriding procedure Cpu_Usage_Packet (Self : in out Instance; Arg : in Packet.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Cpu_Usage_Packet_History.Push (Arg);
   end Cpu_Usage_Packet;
