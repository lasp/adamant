...
private
   ...
   overriding procedure Pet_1_T_Send_Dropped (Self : in out Instance; Arg : in Pet.T) is null;
   -- This procedure is called when a Pet_T_Send message is dropped due to a full queue.
   overriding procedure Pet_2_T_Send_Dropped (Self : in out Instance; Arg : in Pet.T) is null;
