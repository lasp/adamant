--------------------------------------------------------------------------------
-- Memory_Packetizer_Fixed_Id Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Memory_Packetizer_Fixed_Id_Reciprocal;
with Sys_Time;
...
package Component.Memory_Packetizer_Fixed_Id.Implementation.Tester is

   use Component.Memory_Packetizer_Fixed_Id_Reciprocal;
   ...
   type Instance is new Component.Memory_Packetizer_Fixed_Id_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Memory_Packetizer_Fixed_Id.Implementation.Instance;
      -- Connector histories:
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Memory Packetizer Fixed Id component.
   ...
   -----------------------------------------------
   -- Description:
   --    Packets for the Memory Packetizer Fixed Id component.
   -- This packet contains memory dump data from an upstream component.
...
end Component.Memory_Packetizer_Fixed_Id.Implementation.Tester;
