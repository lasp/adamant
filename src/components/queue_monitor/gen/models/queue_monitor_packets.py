...
class queue_monitor_packets(packets):
    """
    This model is a specialized packet suite for the queue monitor packet. This
    class inherits from the normal packets model but adds some extra functionality
    needed to the queue monitor packet. In particular, the queue monitor packet's
    ...
    def set_assembly(self, assembly):
        ...
        super(queue_monitor_packets, self).set_assembly(assembly)
