...
package Sys_Time.Assertion is
   ...
   package Seconds_Assert is new Smart_Assert.Basic (Interfaces.Unsigned_32, Sys_Time.Representation.Seconds_Image);
   package Subseconds_Assert is new Smart_Assert.Basic (Interfaces.Unsigned_32, Sys_Time.Representation.Subseconds_Image);
