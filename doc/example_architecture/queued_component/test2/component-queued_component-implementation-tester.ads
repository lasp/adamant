--------------------------------------------------------------------------------
-- Queued_Component Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Queued_Component_Reciprocal;
with Sys_Time;
...
package Component.Queued_Component.Implementation.Tester is
   ...
   type Instance is new Component.Queued_Component_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Queued_Component.Implementation.Instance;
      -- Connector histories:
...
end Component.Queued_Component.Implementation.Tester;
