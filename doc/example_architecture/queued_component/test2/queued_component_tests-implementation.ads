--------------------------------------------------------------------------------
-- Queued_Component Tests Spec
--------------------------------------------------------------------------------

-- This is a set of unit tests for the Queued Component.
package Queued_Component_Tests.Implementation is
   -- Test data and state:
   type Instance is new Queued_Component_Tests.Base_Instance with private;
private
   -- Fixture procedures:
   ...
   -- Test data and state:
   type Instance is new Queued_Component_Tests.Base_Instance with record
      null;
   end record;
