...
{% if parameters %}
   ...
   -- default parameter values. Called by Init_Base, the first step of component
   -- initialization. An invalid result fails an assertion.
...
{% endif %}
   ...
   -- This function is called when the parameter operation type is "Validate", and by
   -- Assert_Valid_Parameters during Init_Base to check the compiled-in default parameter values. The default implementation of this
