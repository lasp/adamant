...
\vspace{5mm} %5mm vertical space
%- else
This component achieves base class initialization using the \texttt{init\_Base} subprogram. This subprogram takes no parameters. \VAR{init_base.description|e}
%- endif
%- else
