...
{% if endianness in ["either", "big"] %}
   ...
   pragma Warnings (On, "scalar storage order specified for ""Volatile_T_Unconstrained"" does not apply to component");
{% endif %}
{% if endianness in ["either", "little"] %}
   pragma Warnings (On, "scalar storage order specified for ""T_Le"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""T_Le_Unconstrained"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Volatile_T_Le"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Volatile_T_Le_Unconstrained"" does not apply to component");
{% endif %}
{% if element.size == 32 and not element.is_packed_type %}
{% if endianness in ["either", "big"] %}
   pragma Warnings (On, "scalar storage order specified for ""Atomic_T"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Atomic_T_Unconstrained"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Register_T"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Register_T_Unconstrained"" does not apply to component");
{% endif %}
{% if endianness in ["either", "little"] %}
   pragma Warnings (On, "scalar storage order specified for ""Atomic_T_Le"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Atomic_T_Le_Unconstrained"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Register_T_Le"" does not apply to component");
   pragma Warnings (On, "scalar storage order specified for ""Register_T_Le_Unconstrained"" does not apply to component");
{% endif %}
{% endif %}
...
{% if endianness in ["either", "big"] %}
   ...
   pragma Assert (T_Unconstrained'Component_Size = Element_Size,
      "T_Unconstrained component size must equal element size (no padding)");
   pragma Assert (T_Unconstrained_5'Object_Size = 5 * Element_Size,
...
{% if endianness in ["either", "little"] %}
   ...
   pragma Assert (T_Le_Unconstrained'Component_Size = Element_Size,
      "T_Le_Unconstrained component size must equal element size (no padding)");
   pragma Assert (T_Le_Unconstrained_5'Object_Size = 5 * Element_Size,
